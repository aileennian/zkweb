...
import com.yasenagat.zkweb.util.ConfigUtil;
...
public class T {
	...
	public void t() {
		...
		try {
			...
			String host = ConfigUtil.getConfigMessage("host");
			String sessionTimeOut = ConfigUtil.getConfigMessage("sessionTimeOut");
			
			p.setProperty("host", host);
			p.setProperty("sessionTimeOut", sessionTimeOut);
