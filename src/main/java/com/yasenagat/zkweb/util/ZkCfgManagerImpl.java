...
//	jdbc:h2:tcp://localhost/~/test
	 ...
	 final	static String dburl = DBConfigUtil.getConfigMessage("c3p0.jdbcUrl");
	 final	static String dbuser = DBConfigUtil.getConfigMessage("c3p0.user");
	 final static String dbpassword = DBConfigUtil.getConfigMessage("c3p0.password");
		
		

	//private static JdbcConnectionPool cp = JdbcConnectionPool.create("jdbc:h2:tcp://120.24.92.75:19200/~/zkcfg",dbuser,dbuser);
	private static JdbcConnectionPool cp = JdbcConnectionPool.create(dburl,dbuser,dbpassword);
